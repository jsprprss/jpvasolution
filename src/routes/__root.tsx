...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Jasper Presas — GoHighLevel & Automation" },
      { property: "og:description", content: "Premium GoHighLevel implementation, automation systems, and AI workflows." },
